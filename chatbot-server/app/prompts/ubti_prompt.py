...
🚨 중요: plans는 2개, subscription은 1개, 모든 항목에 id와 image_url 필드가 반드시 포함되어야 해!
...
🚨 중요: plans는 반드시 2개, subscription은 1개, 모든 ubti_type과 matching_type에 id와 image_url 필드가 포함되어야 합니다!
